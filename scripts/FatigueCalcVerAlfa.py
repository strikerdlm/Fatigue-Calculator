...
def main():
    ...
    time_min = time_points[cognitive_performances.index(min_perf)].strftime("%H:%M")
    time_max = time_points[cognitive_performances.index(max_perf)].strftime("%H:%M")
    ...
    print(f"Peak performance of {max_perf:.1f} expected around {time_max}")
    print(f"Lowest performance of {min_perf:.1f} expected around {time_min}")
    ...
    ax.fill_between(time_points, 0, 60, facecolor='red', alpha=0.8)
    ax.fill_between(time_points, 60, 80, facecolor='yellow', alpha=0.8)
    ax.fill_between(time_points, 80, 100, facecolor='green', alpha=0.8)
